    ...
    <div class="jumbotron">
        <div class="row">
            <div class="col-md-12">
                ...
                <h3>Your patrons will love browsing your library's collection using Bootstrap visually enhanced,
                ...
                <h3><a href="https://github.com/ashikul/lms-openshift" target='_blank'>By Ashikul
                </a></h3>
            </div>
        </div>
    </div>
